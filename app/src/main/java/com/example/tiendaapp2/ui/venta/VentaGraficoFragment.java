...
public class VentaGraficoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_venta_grafico, container, false);
        barChart = v.findViewById(R.id.barChartVentas);
        cargarDatosGrafico();
        return v;
    }
    ...
    private void cargarDatosGrafico() {
        ...
        String url = Login.servidor + "venta_grafico_mes.php";
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        float total = (float) obj.getDouble("total_ventas"); // ✅ CAMBIO AQUÍ
                    ...
                    dataSet.setColors(Color.rgb(66, 133, 244));
                    ...
                    // Desactivar eje derecho y descripción
                    ...
                    Log.e("VENTA_GRAFICO", "Error parseando JSON", e);
                }
            }

            @Override
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                Log.e("VENTA_GRAFICO", "Error de conexión", error);
            }
        });
    }
}
